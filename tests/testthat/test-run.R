...
test_that("run explicit works", {
  ...
  expect_equal(dim(r1$output$IOx1), c(100 / 1, length(pop$n), 10))
  expect_equal(dim(r1$output$IOx2), c(100 / 1, length(pop$n), 10))
  expect_equal(dim(r1$output$IMV1), c(100 / 1, length(pop$n), 10))
  expect_equal(dim(r1$output$IMV2), c(100 / 1, length(pop$n), 10))
