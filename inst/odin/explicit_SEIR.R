...
# output(n_IOxGetLive1[]) <- TRUE
# output(n_IOxGetDie1[]) <- TRUE
...
delta_R1[] <- n_IOxGetLive2_R[i] + n_IOxNotGetLive2_R[i] + n_IRec2_R[i] + n_IMVNotGetLive2_R[i] + n_IMild_R[i] - n_R1_R2[i]
