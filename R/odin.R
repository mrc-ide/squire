...
less_basic_model_for_js_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "squire",
    user = c("beta_1", "beta_2", "D0", "E0", "gamma", "I_hosp0", "I_ICU0", "I_mild0", "m", "mu", "p_hosp", "p_ICU", "p_mild", "R0", "S0", "sigma"),
...
simple_SEIR_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "squire",
    user = c("beta_set", "dt", "E0", "E02", "gamma_E", "gamma_I", "I0", "mix_mat_set", "N_age", "R0", "S0", "tt_beta", "tt_matrix"),
